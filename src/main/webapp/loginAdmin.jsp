                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <%
                                        Map<String,Administrator> adminFound = (HashMap<String,Administrator>) request.getSession().getAttribute("admin");
                                        
                                        System.out.println(adminFound != null && adminFound.containsKey("admin") && adminFound.get("admin") == null);
                                    %>

                                    <div class="form-container">
                                        <form id="myForm" class="user"  onsubmit="userAndPasswordValidateFormandSubmit(event)" action="SvAdmin" method="GET">
                                            ...
                                            <% if (adminFound != null && adminFound.containsKey("admin") && adminFound.get("admin") == null) { %>
