                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="form-container">
                                        <form id="myForm" class="user"  onsubmit="userAndPasswordValidateFormandSubmit(event)" action="SvAdmin" method="POST">
                                            <h2 class="center">Sign in admin</h2>
                                            <h3 class="center">This form is only to register user admins!</h3>
