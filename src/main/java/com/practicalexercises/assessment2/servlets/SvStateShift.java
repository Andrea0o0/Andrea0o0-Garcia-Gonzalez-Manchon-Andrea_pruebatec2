...
@WebServlet(name = "SvStateShift", urlPatterns = {"/SvStateShift"})
public class SvStateShift extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        shifts = shifts.stream()
                .filter(shift -> shift.isShiftStatus() == state
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
          ...
          Shift initialShift = controller.searchShift((long) id);
          controller.modifyShift(initialShift.getDateHour(), true, initialShift.getAdditionalInformation(), initialShift.getProcedure(), initialShift.getCitizen(), initialShift);
