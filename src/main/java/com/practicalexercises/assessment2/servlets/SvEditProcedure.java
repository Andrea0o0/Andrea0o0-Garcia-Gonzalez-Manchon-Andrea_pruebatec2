...
@WebServlet(name = "SvEditProcedure", urlPatterns = {"/SvEditProcedure"})
public class SvEditProcedure extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        controller.modifyProcedure(title, description, requirements, procedureId.getAdmin(), procedureId.getShifts(), procedureId);
